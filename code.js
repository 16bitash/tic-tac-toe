...
function stop(winnerPlayerNumber) {
    ...
    if (winnerPlayerNumber === 1) {
        ...
        for (let i = 0; i < 3; i++) {
            document.getElementById("block_" + winningIndices[i]).firstElementChild.style.animation =
                "large-small 1s ease 0s infinite";
        }
        ...
        for (let i = 0; i < 3; i++) {
            document.getElementById("block_" + winningIndices[i]).lastElementChild.style.animation =
                "large-small 1s ease 0s infinite";
        }
    } else {
    ...
    document.getElementsByClassName("player1")[0].style.opacity = "1";
    document.getElementsByClassName("player2")[0].style.opacity = "1";
    document.getElementsByClassName("reset-btn")[0].style.animation = "translucent-transperent 1s ease 0s infinite";
}
...
function reset() {
    ...
    for (let i = 0; i < 3; i++) {
        for (let j = 0; j < 3; j++) {
            document.getElementById("block_" + i + j).firstElementChild.style.animation = "";
            document.getElementById("block_" + i + j).lastElementChild.style.animation = "";
        }
    }
...
function changeColor() {
    ...
    if (rgbColor > 0 && rgbColor < 255) {
        ...
        gradient.addColorStop(1, "rgb(" + rgbColor + ", " + rgbColor + ", " + rgbColor + ")");
